...
param_config = {
    ...
    'model_save_path': 'model/Quadrivariate/τ={}_distribution={}_hiddensize={}_λ={}_mae={}_rmse={}.pth'
}
...
train_data = QuadrivariateData(param_config['train_num'], param_config['expectile_level'], param_config['distribution'])
...
for hidden_size, l2_lambda in product(param_config['hidden_size_range'], param_config['l2_lambda_range']):
    ...
    model = ERNN(4, hidden_size).to(param_config['device'])
