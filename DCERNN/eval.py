...
# change K, M, input_dim and distribution every time before start
param_config = {
    'K': 9,
    'M': 50,
    'epochs': 1000,
...
param_config['test_num'] //= param_config['M']
param_config['train_num'] //= param_config['M']
...
np.save(f'data/{param_config["input_dim"]}{param_config["M"]}train_{param_config["distribution"]}.npy', train_loss)
np.save(f'data/{param_config["input_dim"]}{param_config["M"]}test_{param_config["distribution"]}.npy', test_loss)
